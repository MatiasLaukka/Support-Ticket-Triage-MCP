...
export type RetrievalTrace = Omit<Query, "queryText" | "references" | "taxonomy"> & { commandId: string; result: RetrievalResult; candidateCount: number; truncated: boolean; truncatedCount: number; failureCode?: "INDEX_INTEGRITY_ERROR" | "INDEX_UPGRADE_REQUIRED" | "RETRIEVAL_OBSERVATION_FAILED" };
