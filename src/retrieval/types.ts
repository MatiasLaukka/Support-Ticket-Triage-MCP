...
export type ChannelState = { status: "used" | "unavailable" | "stale" | "failed"; reason?: "provider-not-configured" | "provider-timeout" | "provider-http-error" | "provider-unreachable" | "provider-invalid-response" | "cancelled" | "model-version-changed" | "pending-vectors" | "source-unavailable" | "fts-query-error" | "index-integrity-error" | "index-unavailable" };
...
export type RetrievalTrace = Omit<Query, "queryText" | "references" | "taxonomy"> & { commandId: string; result: RetrievalResult; candidateCount: number; truncated: boolean };
