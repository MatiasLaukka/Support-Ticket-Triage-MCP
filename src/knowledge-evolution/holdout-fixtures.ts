...
export function knowledgeHoldoutFixtures(): readonly KnowledgeHoldoutFixture[] {
  return freeze([
    ...
    fixture("stale-version", "stale", { cohort: "governance", forbiddenKnowledgeRef: cause }, "Credential rotation request fails", [suppliedTurn("TKT-5105", { supportState: "information-received", requiredEvidenceSatisfied: false })], policy(["endpoint-url", "request-id", "api-response-status", "sample-payload", "failure-timestamp"], "ordinary-knowledge-article", "Ordinary API fallback applies when unhealthy knowledge is excluded."), { supportState: "information-received", requiredEvidenceSatisfied: false }),
    fixture("contradicted-version", "contradicted", { cohort: "governance", forbiddenKnowledgeRef: cause }, "Credential rotation request fails", [suppliedTurn("TKT-5106", { supportState: "information-received", requiredEvidenceSatisfied: false })], policy(["endpoint-url", "request-id", "api-response-status", "sample-payload", "failure-timestamp"], "ordinary-knowledge-article", "Ordinary API fallback applies when unhealthy knowledge is excluded."), { supportState: "information-received", requiredEvidenceSatisfied: false }),
