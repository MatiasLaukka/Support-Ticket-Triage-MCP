...
import { projectCandidateLearning, projectKnowledgeVersionLearning } from "../src/knowledge-evolution/learning-read-model.js";
...
describe("knowledge learning read model", () => {
  it("projects observed through diagnosis-supported, verified, reuse, and promotion maturity", () => {
    const summary = projectCandidateLearning([
  ...
  it("projects reusable health for the requested version without cross-version contamination", () => {
    const events = [
      event("33333333-3333-4333-8333-333333333333", { eventType: "candidate-promoted", payload: { maturity: "promoted", health: "active", provenance: "operator approved version one" } }),
      event("44444444-4444-4444-8444-444444444444", {
        sourceVersion: 2,
        eventType: "candidate-promoted",
        payload: { maturity: "promoted", health: "active", provenance: "operator approved version two" },
      }),
      event("55555555-5555-4555-8555-555555555555", {
        sourceVersion: 1,
        occurredAt: "2026-08-07T11:00:00.000Z",
        eventType: "knowledge-version-superseded",
        payload: { health: "superseded", replacementVersion: 2, provenance: "version two replaced version one" },
      }),
      event("66666666-6666-4666-8666-666666666666", {
        sourceVersion: 2,
        occurredAt: "2026-08-07T12:00:00.000Z",
        eventType: "knowledge-marked-stale",
        payload: { health: "stale", staleReasons: ["Version two became stale."], provenance: "stale review" },
      }),
    ];
    ...
    })).toMatchObject({ health: "superseded", eligibleForReuse: false });
    expect(projectKnowledgeVersionLearning(events, {
      objectId: "known-cause-api-delay",
      sourceVersion: 2,
      asOf: "2026-08-07T11:30:00.000Z",
    })).toMatchObject({ health: "active", eligibleForReuse: true });
  });
});
